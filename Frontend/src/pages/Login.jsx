        ...
        <div style={{
            ...
            <div style={{
                ...
                <div style={{ textAlign: 'center', marginBottom: '32px' }}>
                    ...
                    <p style={{ color: '#94a3b8', marginTop: '8px', fontSize: '14px' }}>Welcome back! Login to continue coding.</p>
                </div>
                ...
                <div style={{
                    ...
                    <Link to="/register" style={{ color: '#137fec', textDecoration: 'none', fontWeight: 600 }}>
                        Sign up
                    </Link>
                </div>
